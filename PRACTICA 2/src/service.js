...
places.set(0, { Nombre: 'Seat Ibiza', Year: '2022', Color:'Rojo', Motor: '1.5 TSI', caballos:'150', opinion: resena0});
places.set(1, { Nombre: 'John Deree', Year: '2015', Color:'Verde', Motor: '8000 CC', caballos:'180', opinion: resena1 });
places.set(2, { Nombre: 'Citroen C15', Year: '1989', Color:'Gris', Motor: '1.8 TSI', caballos:'65', opinion: resena2 });
places.set(3, { Nombre: 'Audi RS7', Year: '2021', Color:'Negro', Motor: '3.0 GTI', caballos:'248', opinion: resena3 });
places.set(4, { Nombre: 'Seat 600', Year: '1975', Color:'Rojo', Motor: '1.0 Diesel', caballos:'60', opinion: resena4 });
places.set(5, { Nombre: 'Renault F6', Year: '1978', Color:'Blanco', Motor: '1.0 Diesel', caballos:'48', opinion: resena5 });
places.set(6, { Nombre: 'Lamborghini Aventador', Year: '2018', Color:'Rosa', Motor: '3.5 TDI', caballos:'650', opinion: resena6 });
places.set(7, { Nombre: 'Mario Kart', Year: '2023', Color:'Azul', Motor: '4.0 Biturbo', caballos:'80000', opinion: resena7 });
places.set(8, { Nombre: 'Nissan Patrol', Year: '1995', Color:'Gris', Motor: '2.8 Turbo', caballos:'115', opinion: resena8 });
places.set(9, { Nombre: 'Citroen C5', Year: '2020', Color:'Gris', Motor: '2.0 TDI', caballos:'90', opinion: resena9 });
places.set(10, { Nombre: 'Cupra', Year: '2021', Color:'Gris', Motor: '3.0 GTI', caballos:'300', opinion: resena10 });
places.set(11, { Nombre: 'Toyota CHR', Year: '2022', Color:'Blanco', Motor: '1.9 TDI', caballos:'105', opinion: resena11 });
